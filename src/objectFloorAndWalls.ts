import {
  ...
  export const createFloorAndWalls = (envMapIntensity: number) => {
    ...
    const groupConstructionBoxHelper = new BoxHelper(groupConstruction);
    groupConstructionBoxHelper.visible = false;
    groupConstruction.add(groupConstructionBoxHelper);
